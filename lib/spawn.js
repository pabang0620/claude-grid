...
function Set-AllPositions {
    for ($i = 0; $i -lt [Math]::Min($newHwnds.Count, $cells.Count); $i++) {
        $cell = $cells[$i]
        # SWP_NOZORDER | SWP_NOACTIVATE
        [WinPosB]::SetWindowPos([IntPtr]$newHwnds[$i], [IntPtr]::Zero, $cell.x, $cell.y, $cell.w, $cell.h, 0x0014) | Out-Null
    }
}
...
# WT가 초기화 완료 후 크기를 덮어쓸 수 있으므로 4초 후 한번 더 적용
